-- Drop and recreate ltree functions with proper signatures for app.nodes
...
DROP FUNCTION IF EXISTS app.json_set_recursive(jsonb, text[], integer, jsonb);

-- Helper must exist before json_set_by_path
...
-- Update json_set_by_path to understand 'children/items' segments and last-segment matching
