...
const translations = {
  en: {
    ...
    // Storyboard
    storyboard: {
      title: 'Storyboard Playground',
      subtitle: 'Create your personalized storyboard by filling out the details below',
      template: 'Template',
      loadingTemplates: 'Loading templates...',
      selectTemplate: 'Select a template',
      leadCharacter: 'Lead Character',
      name: 'Name',
      enterLeadName: 'Enter the lead character\'s name',
      gender: 'Gender',
      ...
      supportingCharactersDescription: 'Supporting characters will be automatically generated based on your plot and template.',
      ...
      creating: 'Creating Storyboard...',
      warning: 'Warning',
      templatesLoadError: 'Could not load templates. You can still proceed without selecting a template.',
      missingFields: 'Missing fields',
      missingFieldsDescription: 'Please fill in all required fields including template selection',
      missingGenres: 'Missing genres',
      missingGenresDescription: 'Please select at least one genre',
      insufficientCredits: 'Insufficient Credits',
      youNeed: 'You need',
      creditsToStart: 'credits to start this job. Please purchase more credits.',
      error: 'Error',
      failedToCreate: 'Failed to create storyboard job. Please try again.',
      jobCreated: 'Storyboard job created!',
      processingRedirect: 'Your storyboard is being processed. Redirecting to status page...',
