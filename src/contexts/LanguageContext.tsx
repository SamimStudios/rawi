...
const translations = {
  en: {
    ...
    // Usage & Billing
    'usage.title': 'Credits & Plans',
    'usage.credits': 'Credits',
    'usage.totalCredits': 'Total Credits',
    'usage.planCredits': 'Plan Credits',
    'usage.topUpCredits': 'Top-Up Credits',
    'usage.usingPlanCredits': 'Using plan credits',
    'usage.usingTopUpCredits': 'Using top-up credits',
    'usage.noCreditsRemaining': 'No credits remaining',
    'usage.freePlan': 'Free Plan',
    'usage.subscriptionPlans': 'Subscription Plans',
    'usage.oneTimeTopUp': 'One-Time Top-Up',
    'usage.currentPlan': 'Current Plan',
    'usage.recommended': 'Recommended',
    'usage.perWeek': 'per week',
    'usage.selectPlan': 'Select a Plan',
    'usage.upgradePlan': 'Upgrade Plan',
    'usage.changePlan': 'Change Plan',
    'usage.subscribeToPlan': 'Subscribe to a Plan',
    'usage.topUp': 'Top Up Credits',
    'usage.topUpNow': 'Top Up Now',
    'usage.custom': 'Custom amount',
    'usage.viewUsage': 'View Usage',
    'usage.expiresOn': 'Expires on',
    'billing.paymentMethod': 'Payment Method',
    'billing.noPaymentMethod': 'No payment method added',
    'billing.manageInStripe': 'Manage in Stripe',
  ...
  ar: {
    ...
    // Usage & Billing (Arabic)
    'usage.title': 'الرصيد والخطط',
    'usage.credits': 'الرصيد',
    'usage.totalCredits': 'إجمالي الرصيد',
    'usage.planCredits': 'رصيد الخطة',
    'usage.topUpCredits': 'رصيد الشحن',
    'usage.usingPlanCredits': 'استخدام رصيد الخطة',
    'usage.usingTopUpCredits': 'استخدام رصيد الشحن',
    'usage.noCreditsRemaining': 'لا يوجد رصيد متبقي',
    'usage.freePlan': 'الخطة المجانية',
    'usage.subscriptionPlans': 'خطط الاشتراك',
    'usage.oneTimeTopUp': 'شحن لمرة واحدة',
    'usage.currentPlan': 'الخطة الحالية',
    'usage.recommended': 'موصى به',
    'usage.perWeek': 'في الأسبوع',
    'usage.selectPlan': 'اختر خطة',
    'usage.upgradePlan': 'ترقية الخطة',
    'usage.changePlan': 'تغيير الخطة',
    'usage.subscribeToPlan': 'الاشتراك في خطة',
    'usage.topUp': 'شحن الرصيد',
    'usage.topUpNow': 'اشحن الآن',
    'usage.custom': 'مبلغ مخصص',
    'usage.viewUsage': 'عرض الاستخدام',
    'usage.expiresOn': 'ينتهي في',
    'billing.paymentMethod': 'طريقة الدفع',
    'billing.noPaymentMethod': 'لم يتم إضافة طريقة دفع',
    'billing.manageInStripe': 'إدارة في Stripe',
    'billing.currentSubscription': 'الاشتراك الحالي',
    'billing.currentPlan': 'الخطة الحالية',
    'billing.billingCycle': 'دورة الفوترة',
    'billing.weekly': 'أسبوعي',
    'billing.nextBilling': 'الفوترة القادمة',
    'billing.status': 'الحالة',
    'billing.active': 'نشط',
    'billing.canceled': 'ملغي',
    'billing.cancelSubscription': 'إلغاء الاشتراك',
    'billing.reactivateSubscription': 'إعادة تفعيل الاشتراك',
    'billing.transactionHistory': 'تاريخ المعاملات',
    'billing.date': 'التاريخ',
    'billing.type': 'النوع',
    'billing.credits': 'الرصيد',
    'billing.amount': 'المبلغ',
    'billing.invoice': 'الفاتورة',
    'billing.noTransactions': 'لا توجد معاملات بعد',
