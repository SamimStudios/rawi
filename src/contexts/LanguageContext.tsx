...
const translations = {
  en: {
    ...
    // F&B Brands Section
    'fnb.title': 'F&B Brands',
    'fnb.subtitle': 'Manage your restaurant and food brands',
    'fnb.selectBrand': 'Select Brand',
    'fnb.createBrand': 'Create Brand',
    'fnb.noBrands': 'No brands yet',
    'fnb.noBrandsDesc': 'Create your first brand to start generating content',
    'fnb.createFirst': 'Create Your First Brand',
    'fnb.setupProgress': 'Setup Progress',
    'fnb.deleteBrand': 'Delete Brand',
    'fnb.deleteBrandConfirm': 'Are you sure you want to delete this brand? This action cannot be undone.',
    'fnb.brandDeleted': 'Brand deleted successfully',
    'fnb.brandCreated': 'Brand created successfully',
    'fnb.brandUpdated': 'Brand updated successfully',
    'fnb.brandNameRequired': 'Brand name is required',
    
    // F&B Setup Steps
    'fnb.step1Title': 'Brand Information',
    'fnb.step1Desc': 'Basic information about your brand',
    'fnb.step2Title': 'Visual Identity',
    'fnb.step2Desc': 'Logo, colors, and fonts',
    'fnb.step3Title': 'Brand Voice',
    'fnb.step3Desc': 'Tone and communication style',
    'fnb.step4Title': 'Branches',
    'fnb.step4Desc': 'Your branch locations',
    'fnb.step5Title': 'Branch Photos',
    'fnb.step5Desc': 'Interior and exterior photos',
    'fnb.step6Title': 'Menu File',
    'fnb.step6Desc': 'Upload your menu file',
    'fnb.step7Title': 'Menu Items',
    'fnb.step7Desc': 'Add your dishes and products',
    'fnb.step8Title': 'Media Library',
    'fnb.step8Desc': 'Previous photos and videos',
    'fnb.step9Title': 'Content Preferences',
    'fnb.step9Desc': 'Goals and preferred formats',
    'fnb.step10Title': 'Social Links',
    'fnb.step10Desc': 'Your social media accounts',
    'fnb.step11Title': 'Account Owner',
    'fnb.step11Desc': 'Primary contact information',
    
    // F&B Form Fields
    'fnb.brandName': 'Brand Name',
    'fnb.brandNamePlaceholder': 'Enter your brand name',
    'fnb.brandType': 'Business Type',
    'fnb.brandType.restaurant': 'Restaurant',
    'fnb.brandType.cafe': 'Café',
    'fnb.brandType.bakery': 'Bakery',
    'fnb.brandType.cloud_kitchen': 'Cloud Kitchen',
    'fnb.brandType.other': 'Other',
    'fnb.country': 'Country',
    'fnb.city': 'City',
    'fnb.cityPlaceholder': 'Enter city name',
    'fnb.district': 'District',
    'fnb.districtPlaceholder': 'Enter district or area',
    'fnb.defaultLanguage': 'Content Language',
    'fnb.language.ar': 'Arabic',
    'fnb.language.en': 'English',
    'fnb.language.ar_en': 'Arabic & English',
    'fnb.shortBio': 'Short Description',
    'fnb.shortBioPlaceholder': 'Brief description of your brand...',
    'fnb.longBio': 'Detailed Description',
    'fnb.longBioPlaceholder': 'Tell us more about your brand story...',
    'fnb.priceLevel': 'Price Level',
    'fnb.priceLevel.budget': 'Budget-friendly',
    'fnb.priceLevel.mid_range': 'Mid-range',
    'fnb.priceLevel.premium': 'Premium',
    
    // F&B Visual Identity
    'fnb.primaryLogo': 'Primary Logo',
    'fnb.logoUrlPlaceholder': 'Logo URL (upload coming soon)',
    'fnb.logoUrlHint': 'Enter the URL of your logo image',
    'fnb.primaryColor': 'Primary Color',
    'fnb.secondaryColor': 'Secondary Color',
    'fnb.accentColor': 'Accent Color',
    'fnb.primaryFont': 'Primary Font',
    'fnb.fontPlaceholder': 'Font name (e.g., Cairo, Tajawal)',
    
    // F&B Voice & Tone
    'fnb.toneOfVoice': 'Tone of Voice',
    'fnb.tone.warm_friendly': 'Warm & Friendly',
    'fnb.tone.premium_elegant': 'Premium & Elegant',
    'fnb.tone.fun_playful': 'Fun & Playful',
    'fnb.tone.bold_edgy': 'Bold & Edgy',
    'fnb.tone.calm_minimal': 'Calm & Minimal',
    'fnb.tagline': 'Tagline',
    'fnb.taglinePlaceholder': 'Your brand tagline or slogan',
    'fnb.preferredWords': 'Preferred Words',
    'fnb.preferredWordsPlaceholder': 'Words you like to use in content...',
    'fnb.bannedWords': 'Avoid These Words',
    'fnb.bannedWordsPlaceholder': 'Words to avoid in content...',
    
    // F&B Content Preferences
    'fnb.contentGoals': 'Content Goals',
    'fnb.goal.brand_awareness': 'Brand Awareness',
    'fnb.goal.highlight_signature_dishes': 'Highlight Signature Dishes',
    'fnb.goal.promote_offers': 'Promote Offers',
    'fnb.goal.push_delivery': 'Push Delivery',
    'fnb.goal.push_dine_in': 'Push Dine-in',
    'fnb.targetPostsPerWeek': 'Posts per Week',
    'fnb.preferredFormats': 'Preferred Formats',
    'fnb.format.feed_post': 'Feed Post',
    'fnb.format.story': 'Story',
    'fnb.format.reel': 'Reel',
    'fnb.format.tiktok_video': 'TikTok Video',
    'fnb.platforms': 'Platforms',
    'fnb.platform.instagram': 'Instagram',
    'fnb.platform.tiktok': 'TikTok',
    'fnb.platform.snapchat': 'Snapchat',
    'fnb.platform.x': 'X (Twitter)',
    
    // F&B Social Links
    'fnb.instagramUrl': 'Instagram',
    'fnb.tiktokUrl': 'TikTok',
    'fnb.websiteUrl': 'Website',
    'fnb.whatsappNumber': 'WhatsApp',
    
    // F&B Account Owner
    'fnb.ownerName': 'Contact Name',
    'fnb.ownerNamePlaceholder': 'Full name',
    'fnb.ownerEmail': 'Contact Email',
    'fnb.ownerEmailPlaceholder': 'email@example.com',
    'fnb.ownerPhone': 'Contact Phone',
    'fnb.ownerPhonePlaceholder': '+966...',
    
    // F&B Workspace
    'fnb.contentGeneration': 'Content Generation',
    'fnb.contentGenerationDesc': 'Generate images and videos for your brand',
    'fnb.performance': 'Performance',
    'fnb.performanceDesc': 'Track your content performance',
    'fnb.brandSettings': 'Brand Settings',
    'fnb.generateContent': 'Generate Content',
    'fnb.generateContentDesc': 'Describe the content you want to create',
    'fnb.contentType': 'Content Type',
    'fnb.image': 'Image',
    'fnb.video': 'Video',
    'fnb.both': 'Both',
    'fnb.prompt': 'Prompt',
    'fnb.promptPlaceholder': 'Describe what you want to create...',
    'fnb.promptRequired': 'Please enter a prompt',
    'fnb.generate': 'Generate',
    'fnb.autoSchedule': 'Auto Schedule',
    'fnb.activeRequests': 'Active Requests',
    'fnb.status.pending': 'Pending',
    'fnb.status.processing': 'Processing',
    'fnb.status.completed': 'Completed',
    'fnb.status.failed': 'Failed',
    'fnb.requestCreated': 'Request created successfully',
    'fnb.all': 'All',
    'fnb.images': 'Images',
    'fnb.videos': 'Videos',
    'fnb.favorites': 'Favorites',
    'fnb.noContentYet': 'No content yet',
    'fnb.noContentDescription': 'Generate your first content to see it here',
    'fnb.generateFirst': 'Generate First Content',
    'fnb.archive': 'Archive',
    
    // F&B Performance (Placeholder)
    'fnb.performanceComingSoon': 'Performance Dashboard Coming Soon',
    'fnb.performanceComingSoonDesc': 'Track impressions, engagement, and revenue from your content',
    'fnb.totalImpressions': 'Total Impressions',
    'fnb.totalReach': 'Total Reach',
    'fnb.totalEngagement': 'Total Engagement',
    'fnb.weeklyGrowth': 'Weekly Growth',
    'fnb.topPosts': 'Top Posts',
    'fnb.recentPosts': 'Recent Posts',
  },
  ar: {
    ...
    // F&B Brands Section (Arabic)
    'fnb.title': 'براندات المطاعم',
    'fnb.subtitle': 'إدارة علاماتك التجارية للمطاعم والمأكولات',
    'fnb.selectBrand': 'اختر البراند',
    'fnb.createBrand': 'إنشاء براند',
    'fnb.noBrands': 'لا توجد براندات',
    'fnb.noBrandsDesc': 'أنشئ أول براند لبدء إنتاج المحتوى',
    'fnb.createFirst': 'أنشئ أول براند',
    'fnb.setupProgress': 'تقدم الإعداد',
    'fnb.deleteBrand': 'حذف البراند',
    'fnb.deleteBrandConfirm': 'هل أنت متأكد من حذف هذا البراند؟ لا يمكن التراجع عن هذا الإجراء.',
    'fnb.brandDeleted': 'تم حذف البراند بنجاح',
    'fnb.brandCreated': 'تم إنشاء البراند بنجاح',
    'fnb.brandUpdated': 'تم تحديث البراند بنجاح',
    'fnb.brandNameRequired': 'اسم البراند مطلوب',
    
    // F&B Setup Steps (Arabic)
    'fnb.step1Title': 'بيانات البراند',
    'fnb.step1Desc': 'المعلومات الأساسية عن علامتك التجارية',
    'fnb.step2Title': 'الهوية البصرية',
    'fnb.step2Desc': 'الشعار والألوان والخطوط',
    'fnb.step3Title': 'نبرة الصوت',
    'fnb.step3Desc': 'أسلوب التواصل والكتابة',
    'fnb.step4Title': 'الفروع',
    'fnb.step4Desc': 'مواقع فروعك',
    'fnb.step5Title': 'صور الفروع',
    'fnb.step5Desc': 'صور داخلية وخارجية',
    'fnb.step6Title': 'ملف المنيو',
    'fnb.step6Desc': 'رفع ملف قائمة الطعام',
    'fnb.step7Title': 'عناصر المنيو',
    'fnb.step7Desc': 'إضافة الأطباق والمنتجات',
    'fnb.step8Title': 'مكتبة الوسائط',
    'fnb.step8Desc': 'الصور والفيديوهات السابقة',
    'fnb.step9Title': 'تفضيلات المحتوى',
    'fnb.step9Desc': 'الأهداف والصيغ المفضلة',
    'fnb.step10Title': 'روابط التواصل',
    'fnb.step10Desc': 'حسابات التواصل الاجتماعي',
    'fnb.step11Title': 'صاحب الحساب',
    'fnb.step11Desc': 'معلومات التواصل الرئيسية',
    
    // F&B Form Fields (Arabic)
    'fnb.brandName': 'اسم البراند',
    'fnb.brandNamePlaceholder': 'أدخل اسم علامتك التجارية',
    'fnb.brandType': 'نوع النشاط',
    'fnb.brandType.restaurant': 'مطعم',
    'fnb.brandType.cafe': 'كافيه',
    'fnb.brandType.bakery': 'مخبز',
    'fnb.brandType.cloud_kitchen': 'مطبخ سحابي',
    'fnb.brandType.other': 'أخرى',
    'fnb.country': 'الدولة',
    'fnb.city': 'المدينة',
    'fnb.cityPlaceholder': 'أدخل اسم المدينة',
    'fnb.district': 'الحي / المنطقة',
    'fnb.districtPlaceholder': 'أدخل اسم الحي أو المنطقة',
    'fnb.defaultLanguage': 'لغة المحتوى',
    'fnb.language.ar': 'العربية',
    'fnb.language.en': 'الإنجليزية',
    'fnb.language.ar_en': 'عربي وإنجليزي',
    'fnb.shortBio': 'وصف قصير',
    'fnb.shortBioPlaceholder': 'وصف مختصر عن البراند...',
    'fnb.longBio': 'وصف تفصيلي',
    'fnb.longBioPlaceholder': 'أخبرنا المزيد عن قصة البراند...',
    'fnb.priceLevel': 'مستوى الأسعار',
    'fnb.priceLevel.budget': 'اقتصادي',
    'fnb.priceLevel.mid_range': 'متوسط',
    'fnb.priceLevel.premium': 'فاخر',
    
    // F&B Visual Identity (Arabic)
    'fnb.primaryLogo': 'الشعار الرئيسي',
    'fnb.logoUrlPlaceholder': 'رابط الشعار (الرفع قريباً)',
    'fnb.logoUrlHint': 'أدخل رابط صورة الشعار',
    'fnb.primaryColor': 'اللون الأساسي',
    'fnb.secondaryColor': 'اللون الثانوي',
    'fnb.accentColor': 'لون الإبراز',
    'fnb.primaryFont': 'الخط الأساسي',
    'fnb.fontPlaceholder': 'اسم الخط (مثال: Cairo, Tajawal)',
    
    // F&B Voice & Tone (Arabic)
    'fnb.toneOfVoice': 'نبرة الصوت',
    'fnb.tone.warm_friendly': 'ودود ودافئ',
    'fnb.tone.premium_elegant': 'فاخر وأنيق',
    'fnb.tone.fun_playful': 'مرح وممتع',
    'fnb.tone.bold_edgy': 'جريء ومميز',
    'fnb.tone.calm_minimal': 'هادئ وبسيط',
    'fnb.tagline': 'الشعار النصي',
    'fnb.taglinePlaceholder': 'شعار أو سلوقان البراند',
    'fnb.preferredWords': 'كلمات مفضلة',
    'fnb.preferredWordsPlaceholder': 'كلمات تحب استخدامها في المحتوى...',
    'fnb.bannedWords': 'كلمات يجب تجنبها',
    'fnb.bannedWordsPlaceholder': 'كلمات لا تريد استخدامها...',
    
    // F&B Content Preferences (Arabic)
    'fnb.contentGoals': 'أهداف المحتوى',
    'fnb.goal.brand_awareness': 'الوعي بالعلامة',
    'fnb.goal.highlight_signature_dishes': 'إبراز الأطباق المميزة',
    'fnb.goal.promote_offers': 'ترويج العروض',
    'fnb.goal.push_delivery': 'تشجيع التوصيل',
    'fnb.goal.push_dine_in': 'تشجيع الزيارة',
    'fnb.targetPostsPerWeek': 'المنشورات أسبوعياً',
    'fnb.preferredFormats': 'الصيغ المفضلة',
    'fnb.format.feed_post': 'منشور فيد',
    'fnb.format.story': 'ستوري',
    'fnb.format.reel': 'ريلز',
    'fnb.format.tiktok_video': 'فيديو تيك توك',
    'fnb.platforms': 'المنصات',
    'fnb.platform.instagram': 'انستجرام',
    'fnb.platform.tiktok': 'تيك توك',
    'fnb.platform.snapchat': 'سناب شات',
    'fnb.platform.x': 'إكس (تويتر)',
    
    // F&B Social Links (Arabic)
    'fnb.instagramUrl': 'انستجرام',
    'fnb.tiktokUrl': 'تيك توك',
    'fnb.websiteUrl': 'الموقع الإلكتروني',
    'fnb.whatsappNumber': 'واتساب',
    
    // F&B Account Owner (Arabic)
    'fnb.ownerName': 'اسم المسؤول',
    'fnb.ownerNamePlaceholder': 'الاسم الكامل',
    'fnb.ownerEmail': 'البريد الإلكتروني',
    'fnb.ownerEmailPlaceholder': 'email@example.com',
    'fnb.ownerPhone': 'رقم الهاتف',
    'fnb.ownerPhonePlaceholder': '+966...',
    
    // F&B Workspace (Arabic)
    'fnb.contentGeneration': 'إنشاء المحتوى',
    'fnb.contentGenerationDesc': 'إنشاء صور وفيديوهات لبراندك',
    'fnb.performance': 'الأداء',
    'fnb.performanceDesc': 'تتبع أداء المحتوى',
    'fnb.brandSettings': 'إعدادات البراند',
    'fnb.generateContent': 'إنشاء محتوى',
    'fnb.generateContentDesc': 'صف المحتوى الذي تريد إنشاءه',
    'fnb.contentType': 'نوع المحتوى',
    'fnb.image': 'صورة',
    'fnb.video': 'فيديو',
    'fnb.both': 'كلاهما',
    'fnb.prompt': 'الوصف',
    'fnb.promptPlaceholder': 'صف ما تريد إنشاءه...',
    'fnb.promptRequired': 'الرجاء إدخال وصف',
    'fnb.generate': 'إنشاء',
    'fnb.autoSchedule': 'جدولة تلقائية',
    'fnb.activeRequests': 'الطلبات النشطة',
    'fnb.status.pending': 'قيد الانتظار',
    'fnb.status.processing': 'قيد المعالجة',
    'fnb.status.completed': 'مكتمل',
    'fnb.status.failed': 'فشل',
    'fnb.requestCreated': 'تم إنشاء الطلب بنجاح',
    'fnb.all': 'الكل',
    'fnb.images': 'الصور',
    'fnb.videos': 'الفيديوهات',
    'fnb.favorites': 'المفضلة',
    'fnb.noContentYet': 'لا يوجد محتوى بعد',
    'fnb.noContentDescription': 'أنشئ أول محتوى لرؤيته هنا',
    'fnb.generateFirst': 'إنشاء أول محتوى',
    'fnb.archive': 'أرشفة',
    
    // F&B Performance (Arabic - Placeholder)
    'fnb.performanceComingSoon': 'لوحة الأداء قريباً',
    'fnb.performanceComingSoonDesc': 'تتبع المشاهدات والتفاعل والإيرادات من محتواك',
    'fnb.totalImpressions': 'إجمالي المشاهدات',
    'fnb.totalReach': 'الوصول الكلي',
    'fnb.totalEngagement': 'إجمالي التفاعل',
    'fnb.weeklyGrowth': 'النمو الأسبوعي',
    'fnb.topPosts': 'أفضل المنشورات',
    'fnb.recentPosts': 'المنشورات الأخيرة',
  }
};
